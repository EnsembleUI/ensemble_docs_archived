...
| onTap | action | __NOTE:__ Currently it doesn't work for Ensemble Studio and for some Web builds. Run a block of code or execute a given action when there is a tap event on lottie widget |
