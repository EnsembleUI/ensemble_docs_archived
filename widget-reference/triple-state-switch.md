# TripleStateSwitch widget

The TripleStateSwitch Widget enables the rendering of switch toggle elements, providing users with an intuitive and interactive way to toggle between three states within your application.
...
| value        | string  | Specifying the value of your Switch Widget                                                                                                               |                                                                       |
...
| intermediateColor              | integer or string | Sets the middle state color of the switch widget, starting with '0xFF' for full opacity. `transparent` `black` `blue` `white` `red` `grey` `teal` `amber` `pink` `purple` `yellow` `green` `brown` `cyan` `indigo` `lime` `orange`                                                                           |
